...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_split_3x5_3(
    ...
    KC_TRNS, LT(1, KC_SPC), LT(3, KC_TAB), LT(2, KC_BSPC), KC_ENT, KC_TRNS
  ),
  // numbers
  ...
  [3] = LAYOUT_split_3x5_3(
    KC_LALT, KC_VOLD, KC_MUTE, KC_VOLU, KC_CAPS, KC_TRNS, KC_PGDN, KC_UP, KC_PGUP, KC_DEL,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_GRV, KC_LALT, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_LGUI, KC_TRNS, KC_PGDN, KC_VOLD, KC_TRNS, KC_TRNS, KC_TRNS,
